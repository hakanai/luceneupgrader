 ...
 * and retrieve it many times. If {@code #set(Object)} is called more than once,
 * {@code AlreadySetException} is thrown and the operation
 * will fail.
 *
 * @lucene.experimental
 */
public final class SetOnce<T> {
  ...
  /** Thrown when {@code SetOnce#set(Object)} is called more than once. */
   ...
   * setting it by calling {@code #set(Object)}.
   */
  public SetOnce() {
  ...
  /** Returns the object set by {@code #set(Object)}. */
  public final T get() {
    return obj;
  }
}
