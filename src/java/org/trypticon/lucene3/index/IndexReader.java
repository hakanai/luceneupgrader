...
public abstract class IndexReader implements Cloneable,Closeable {
  ...
  /**
   * Open a near real time IndexReader from the {@code org.trypticon.lucene3.index.IndexWriter}.
   *
  ...
  /**
   * Get the {@code org.trypticon.lucene3.document.Document} at the <code>n</code>
   * <sup>th</sup> position. The {@code FieldSelector} may be used to determine
   * what {@code org.trypticon.lucene3.document.Field}s to load and how they should
   * be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
   * <code>FieldsReader</code>) is closed before the lazy
   * {@code org.trypticon.lucene3.document.Field} is loaded an exception may be
   * thrown. If you want the value of a lazy
   * {@code org.trypticon.lucene3.document.Field} to be available after closing you
   ...
   *         {@code org.trypticon.lucene3.document.Document} at the nth position
   * @throws CorruptIndexException if the index is corrupt
   * @throws IOException if there is a low-level IO error
   *
   *
   ...
   * org.trypticon.lucene3.document.Fieldable#setBoost(float) boost} and its {@code Similarity#lengthNorm(String,
