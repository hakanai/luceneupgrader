...
import org.trypticon.lucene3.document.AbstractField;  // for javadocs
...
import org.trypticon.lucene3.util.CommandLineUtil;
...
public class CheckIndex {
  ...
  public static class Status {
    ...
    public static class SegmentInfoStatus {
       ...
       *  has position data
       *  @see AbstractField#setIndexOptions(org.trypticon.lucene3.index.FieldInfo.IndexOptions) */
  ...
  /** Command-line interface to check and fix an index.
    ...
    Run it like this:
    <pre>
    java -ea:org.trypticon.lucene3... org.trypticon.lucene3.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    if (indexPath == null) {
      ...
      System.out.println("\nUsage: java org.trypticon.lucene3.index.CheckIndex pathToIndex [-fix] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:org.trypticon.lucene3...', so assertions are enabled");
