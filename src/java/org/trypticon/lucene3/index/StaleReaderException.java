...
/**
 * This exception is thrown when an {@code IndexReader}
 * tries to make changes to the index (via {@code
 * IndexReader#deleteDocument}, {@code
 * IndexReader#undeleteAll} or {@code IndexReader#setNorm})
