...
public abstract class AttributeImpl implements Cloneable, Serializable, Attribute {  
  ...
  private boolean assertExternalClass(Class<? extends AttributeImpl> clazz) {
    ...
    return (!name.startsWith("org.trypticon.lucene3.") && !name.startsWith("org.apache.solr."))
      || name.equals("org.trypticon.lucene3.util.TestAttributeSource$TestAttributeImpl");
  }
