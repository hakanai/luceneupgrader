 ...
 * borrowed from {@link org.trypticon.lucene3.store.IndexInput} and
 * {@link org.trypticon.lucene3.store.IndexOutput}.
 * <p>
...
public class SortedVIntList extends DocIdSet {
  ...
  private class SortedVIntListBuilder {
    ...
    void addInt(int nextInt) {
      ...
      // See org.trypticon.lucene3.store.IndexOutput.writeVInt()
  ...
  public DocIdSetIterator iterator() {
    return new DocIdSetIterator() {
      ...
      private void advance() {
        // See org.trypticon.lucene3.store.IndexInput.readVInt()
