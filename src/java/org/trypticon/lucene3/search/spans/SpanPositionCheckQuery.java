...
public abstract class SpanPositionCheckQuery extends SpanQuery implements Cloneable {
   ...
   * "match" {@link org.trypticon.lucene3.search.spans.SpanQuery}.
   *
   * This is only called if the underlying {@link org.trypticon.lucene3.search.spans.Spans#next()} for the
   * match is successful
   *
   *
   * @param spans The {@link org.trypticon.lucene3.search.spans.Spans} instance, positioned at the spot to check
   * @return whether the match is accepted, rejected, or rejected and should move to the next doc.
   *
   * @see org.trypticon.lucene3.search.spans.Spans#next()
   *
   */
