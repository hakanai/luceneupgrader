 ...
 * <p/>
 * This filter does not cache.  See the {@link org.trypticon.luceneupgrader.lucene3.internal.lucene.search.CachingSpanFilter} for a wrapper that
 * caches.
 */
public class SpanQueryFilter extends SpanFilter {
   ...
   * <code>query</code>.
   * @param query The {@link org.trypticon.luceneupgrader.lucene3.internal.lucene.search.spans.SpanQuery} to use as the basis for the Filter.
   */
