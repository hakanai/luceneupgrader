...
public class PositionBasedTermVectorMapper extends TermVectorMapper{
   ...
   *
   * @return A map between field names and a Map.  The sub-Map key is the position as the integer, the value is {@link org.trypticon.luceneupgrader.lucene3.internal.lucene.index.PositionBasedTermVectorMapper.TVPositionInfo}.
   */
