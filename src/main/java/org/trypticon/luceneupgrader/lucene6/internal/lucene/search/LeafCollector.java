...
public interface LeafCollector {
   ...
   * current {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.LeafReaderContext} will be skipped and {@link IndexSearcher}
   * will swallow the exception and continue collection with the next leaf.
   * <p>
   * Note: This is called in an inner search loop. For good search performance,
   * implementations of this method should not call {@link IndexSearcher#doc(int)} or
   * {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.IndexReader#document(int)} on every hit.
