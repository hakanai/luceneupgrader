 ...
 * </h3>
 * <p>
 * {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Fields} is the initial entry point into the 
 ...
 * </h3>
 * <p>
 * {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Terms} represents the collection of terms
 ...
 * }
 * </pre>
 * {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.TermsEnum} provides an iterator over the list
 ...
 * </h3>
 * <p>
 *   {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.PostingsEnum} is an extension of
 *   {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.search.DocIdSetIterator}that iterates over the list of
 ...
 * </h3>
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.TermsEnum#docFreq}: Returns the number of 
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.TermsEnum#totalTermFreq}: Returns the number 
 ...
 *            from the index 
 *            ({@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.IndexOptions#DOCS DOCS}) 
 ...
 * </h3>
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Terms#size}: Returns the number of 
 *            unique terms in the field. This statistic may be unavailable 
 *            (returns <code>-1</code>) for some Terms implementations such as
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.MultiTerms}, where it cannot be efficiently
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Terms#getDocCount}: Returns the number of
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Terms#getSumDocFreq}: Returns the number of
 *            postings (term-document mappings in the inverted index) for the field. This
 *            can be thought of as the sum of {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.TermsEnum#docFreq}
 *            across all terms in the field, and like docFreq() it will also count postings
 *            that appear in deleted documents.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Terms#getSumTotalTermFreq}: Returns the number
 *            of tokens for the field. This can be thought of as the sum of 
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.TermsEnum#totalTermFreq} across all terms in the
 ...
 * </h3>
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.IndexReader#maxDoc}: Returns the number of 
 *            documents (including deleted documents) in the index. 
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.IndexReader#numDocs}: Returns the number 
 *            of live documents (excluding deleted documents) in the index.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.IndexReader#numDeletedDocs}: Returns the
 *            number of deleted documents in the index.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.Fields#size}: Returns the number of indexed
 *            fields.
 *     </ul>
 ...
 * a {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.search.similarities.Similarity} implementation will store some
 * of these values (possibly in a lossy way), into the normalization value for the document in
 * its {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.search.similarities.Similarity#computeNorm} method.
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getLength}: Returns the number of 
 *            tokens for this field in the document. Note that this is just the number
 *            of times that {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.TokenStream#incrementToken} returned
 *            true, and is unrelated to the values in 
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute}.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getNumOverlap}: Returns the number
 ...
 *            such as synonyms.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getPosition}: Returns the accumulated
 *            position value for this field in the document: computed from the values of
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute} and including
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.Analyzer#getPositionIncrementGap}s across multivalued
 *            fields.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getOffset}: Returns the total
 *            character offset value for this field in the document: computed from the values of
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.tokenattributes.OffsetAttribute} returned by 
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.TokenStream#end}, and including
 *            {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.Analyzer#getOffsetGap}s across multivalued
 *            fields.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getUniqueTermCount}: Returns the number
 *            of unique terms encountered for this field in the document.
 *        <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.FieldInvertState#getMaxTermFrequency}: Returns the maximum
 ...
 * accessed via {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.index.LeafReader#getNumericDocValues}.
 */
