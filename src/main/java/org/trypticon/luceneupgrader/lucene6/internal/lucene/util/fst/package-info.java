 ...
 *    <li>Optional two-pass compression: {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.FST#pack FST.pack()}</li>
 *    <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.Util#getByOutput Lookup-by-output} when the 
 *        outputs are in sorted order (e.g., ordinals or file pointers)</li>
 *    <li>Pluggable {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.Outputs Outputs} representation</li>
 *    <li>{@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.Util#shortestPaths N-shortest-paths} search by
 *        weight</li>
 *    <li>Enumerators ({@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.IntsRefFSTEnum IntsRef} and {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.fst.BytesRefFSTEnum BytesRef}) that behave like {@link java.util.SortedMap SortedMap} iterators
 * </ul>
 * <p>
