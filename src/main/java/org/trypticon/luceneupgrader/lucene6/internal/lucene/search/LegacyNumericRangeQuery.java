 ...
 * numeric values using {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyIntField}, {@link
 * org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyFloatField}, {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyLongField} or {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyDoubleField} (expert: {@link
 * org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.LegacyNumericTokenStream}).  If your terms are instead textual,
 ...
 * see {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.LegacyNumericUtils}). A range is then divided recursively into multiple intervals for searching:
 ...
 * of indexed terms per value is (those are generated by {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.analysis.LegacyNumericTokenStream}):
 ...
 *  <code>precisionStep</code>). Using {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyIntField},
 *  {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyLongField}, {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyFloatField} or {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.document.LegacyDoubleField} for sorting
...
public final class LegacyNumericRangeQuery<T extends Number> extends MultiTermQuery {
  ...
  /**
   * Factory that creates a <code>LegacyNumericRangeQuery</code>, that queries a <code>long</code>
   * range using the default <code>precisionStep</code> {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.LegacyNumericUtils#PRECISION_STEP_DEFAULT} (16).
   * You can have half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries)
   * by setting the min or max value to <code>null</code>. By setting inclusive to false, it will
   * match all documents excluding the bounds, with inclusive on, the boundaries are hits, too.
   */
  ...
  /**
   * Factory that creates a <code>LegacyNumericRangeQuery</code>, that queries a <code>int</code>
   * range using the default <code>precisionStep</code> {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.LegacyNumericUtils#PRECISION_STEP_DEFAULT_32} (8).
   * You can have half-open ranges (which are in fact &lt;/&le; or &gt;/&ge; queries)
   * by setting the min or max value to <code>null</code>. By setting inclusive to false, it will
   * match all documents excluding the bounds, with inclusive on, the boundaries are hits, too.
   */
   ...
   * {@link Term#compareTo}.
   * The ordering depends on how {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.LegacyNumericUtils#splitLongRange} and
   * {@link org.trypticon.luceneupgrader.lucene6.internal.lucene.util.LegacyNumericUtils#splitIntRange} generates the sub-ranges. For
