...
import org.trypticon.luceneupgrader.lucene6.internal.lucene.index.CheckIndex.Status.DocValuesStatus;
...
import org.trypticon.luceneupgrader.lucene6.internal.lucene.search.LeafFieldComparator;
...
import org.trypticon.luceneupgrader.lucene6.internal.lucene.util.CommandLineUtil;
...
public final class CheckIndex implements Closeable {
  ...
  private static int doMain(String args[]) throws IOException, InterruptedException {
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:org.trypticon.luceneupgrader.lucene6.internal.lucene...', so assertions are enabled");
  ...
  public static Options parseOptions(String[] args) {
    ...
    if (opts.indexPath == null) {
      throw new IllegalArgumentException("\nERROR: index path not specified" +
                         "\nUsage: java org.trypticon.luceneupgrader.lucene6.internal.lucene.index.CheckIndex pathToIndex [-exorcise] [-crossCheckTermVectors] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
