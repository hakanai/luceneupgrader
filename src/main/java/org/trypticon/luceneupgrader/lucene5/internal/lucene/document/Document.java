...
import org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexReader;  // for javadoc
import org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexableField;
import org.trypticon.luceneupgrader.lucene5.internal.lucene.search.IndexSearcher;  // for javadoc
import org.trypticon.luceneupgrader.lucene5.internal.lucene.search.ScoreDoc; // for javadoc
import org.trypticon.luceneupgrader.lucene5.internal.lucene.util.BytesRef;

/** Documents are the unit of indexing and search.
 *
 * A Document is a set of fields.  Each field has a name and a textual value.
 * A field may be {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexableFieldType#stored() stored} with the document, in which
 * case it is returned with search hits on the document.  Thus each document
 * should typically contain one or more stored fields which uniquely identify
 * it.
 *
 * <p>Note that fields which are <i>not</i> {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexableFieldType#stored() stored} are
