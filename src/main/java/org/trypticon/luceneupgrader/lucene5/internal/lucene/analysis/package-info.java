...
/**
 * Text analysis. 
 * <p>API and code to convert text into indexable/searchable tokens.  Covers {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} and related classes.</p>
 ...
 * <ul>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} &ndash; An <code>Analyzer</code> is
 *     responsible for supplying a
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream} which can be consumed
 *     by the indexing and searching processes.  See below for more information
 *     on implementing your own {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}. Most of the time, you can use
 *     an anonymous subclass of {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}.
 *   </li>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.CharFilter} &ndash; <code>CharFilter</code> extends
 ...
 *     that are not the same as those in the original text. {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer#setReader(java.io.Reader)}
 *     accept <code>CharFilter</code>s.  <code>CharFilter</code>s may
 *     be chained to perform multiple pre-tokenization modifications.
 *   </li>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer} &ndash; A <code>Tokenizer</code> is a
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream} and is responsible for
 *     breaking up incoming text into tokens. In many cases, an {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} will
 *     use a {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer} as the first step in the analysis process.  However,
 *     to modify text prior to tokenization, use a {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.CharFilter} subclass (see
 *     above).
 *   </li>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenFilter} &ndash; A <code>TokenFilter</code> is
 *     a {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream} and is responsible
 ...
 * <p>
 *   The relationship between {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} and
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.CharFilter}s,
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer}s,
 *   and {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenFilter}s is sometimes confusing. To ease
 *   this confusion, here is some clarifications:
 * </p>
 * <ul>
 *   <li>
 *     The {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} is a
 ...
 *     to produce {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream}s that accept a
 *     reader and produces tokens, and to wrap or otherwise
 *     pre-process {@link java.io.Reader} objects.
 *   </li>
 *   <li>
 *   The {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.CharFilter} is a subclass of
 *  {@link java.io.Reader} that supports offset tracking.
 *   </li>
 *   <li>The{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer}
 *     is only responsible for <u>breaking</u> the input text into tokens.
 *   </li>
 *   <li>The{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenFilter} modifies a
 *   stream of tokens and their contents.
 *   </li>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer} is a {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream},
 *     but {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} is not.
 *   </li>
 *   <li>
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} is "field aware", but
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer} is not. {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}s may
 *     take a field name into account when constructing the {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream}.
 *   </li>
 * </ul>
 * <p>
 ...
 *   create an anonymous subclass of {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}, provide {@link
 *   org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer#createComponents(String)} and perhaps also
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer#initReader(String,
 *   java.io.Reader)}. However, if you need the same set of components
 *   over and over in many places, you can make a subclass of
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}. In fact, Apache Lucene
 ...
 *  {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.document.Field}s.  The PerFieldAnalyzerWrapper can be used to associate a different <code>Analyzer</code> with different
 *  {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.document.Field}s. There is a great deal of
 ...
 *     {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexWriter#addDocument(Iterable) addDocument(doc)},
 ...
 *         // Use {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeSource#reflectAsString(boolean)}
 ...
 * <p>
 *   Creating your own Analyzer is straightforward. Your Analyzer should subclass {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer}. It can use
 ...
 * <p>
 *   When {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.document.Document#add(org.trypticon.luceneupgrader.lucene5.internal.lucene.index.IndexableField) document.add(field)}
 *   is called multiple times for the same field name, we could say that each such call creates a new 
 *   section for that field in that document. 
 *   In fact, a separate call to 
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer#tokenStream(java.lang.String, java.io.Reader) tokenStream(field,reader)}
 ...
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer#getPositionIncrementGap(java.lang.String) Analyzer.getPositionIncrementGap(fieldName)}:
 * </p>
 * <PRE class="prettyprint">
 *   Version matchVersion = Version.LUCENE_XY; // Substitute desired Lucene version for XY
 ...
 * <p>
 *    At the ends of each field, Lucene will call the {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#end()}.
 ...
 * </p>
 * <p>
 *    The base method{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#end()} sets PositionIncrement to 0, which is required.
 ...
 *    {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute#getPositionIncrement() position increment} of all tokens to be one.
 ...
 *    {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.PositionLengthAttribute#getPositionLength() position length} of one.
 ...
 *   org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeSource#clearAttributes()} in
 *   incrementToken().</li>
 *   <li>Tokenizers must override {@link
 *   org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#end()}, and pass the final
 *   offset (the total number of input characters processed) to both
 *   parameters of {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.OffsetAttribute#setOffset(int, int)}.</li>
 * </ul>
 * <p>
 ...
 *   <li>When they add tokens, token filters should call {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeSource#clearAttributes()} first.</li>
 ...
 * <p>
 *   Classes {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.Attribute} and
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeSource} serve as the basis upon which
 ...
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.CharTermAttribute}
 *   contains the term text of a token, and 
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.OffsetAttribute} contains
 ...
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.CharTermAttribute}</td>
 *     <td>
 ...
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.OffsetAttribute}</td>
 *     <td>The start and end offset of a token in characters.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute}</td>
 *     <td>See above for detailed information about position increment.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.PositionLengthAttribute}</td>
 *     <td>The number of positions occupied by a token.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.PayloadAttribute}</td>
 *     <td>The payload that a Token can optionally have.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.TypeAttribute}</td>
 *     <td>The type of the token. Default is 'word'.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.FlagsAttribute}</td>
 *     <td>Optional flags a token can have.</td>
 *   </tr>
 *   <tr>
 *     <td>{@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.tokenattributes.KeywordAttribute}</td>
 *     <td>
 ...
 * opposite. {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Analyzer} applies a reuse
 * strategy to the tokenizer and the token filters. It will reuse
 * them. For each new input, it calls {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer#setReader(java.io.Reader)}
 * to set the input. Your components must be prepared for this scenario,
 * as described below.
 * <h4>Tokenizer</h4>
 * <ul>
 *   <li>
 *   You should create your tokenizer class by extending {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer}.
 *   </li>
 *   <li>
 *   Your tokenizer <strong>must</strong> override {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#end()}.
 ...
 *   </li>
 *   <li>
 *   If your tokenizer overrides {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#reset()}
 *   or {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#close()}, it
 *   <strong>must</strong> call the corresponding superclass method.
 *   </li>
 * </ul>
 * <h4>Token Filter</h4>
 *   You should create your token filter class by extending {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenFilter}.
 *   If your token filter overrides {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#reset()},
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#end()}
 *   or {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.TokenStream#close()}, it
 *   <strong>must</strong> call the corresponding superclass method.
 * <h4>Creating delegates</h4>
 *   Forwarding classes (those which extend {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer} but delegate
 *   selected logic to another tokenizer) must also set the reader to the delegate in the overridden
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.Tokenizer#reset()} method, e.g.:
 *   <pre class="prettyprint">
 ...
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeFactory}. The factory accepts an Attribute interface as argument
 ...
 *   {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.util.AttributeImpl}:
 * </p>
 * <pre class="prettyprint">
 ...
 * text.
 * <p>
 * {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.analysis.CharFilter} is designed to allow you to pre-process input like a FilterReader would, but also
