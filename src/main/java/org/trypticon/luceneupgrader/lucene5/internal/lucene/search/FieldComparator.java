 ...
 * 
 *  <li> {@link #getLeafComparator(org.trypticon.luceneupgrader.lucene5.internal.lucene.index.LeafReaderContext)} Invoked
...
public abstract class FieldComparator<T> {
   ...
   * {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.index.LeafReaderContext}. All docIDs supplied to
   ...
   *  org.trypticon.luceneupgrader.lucene5.internal.lucene.index.LeafReader#getNumericDocValues} and sorts by ascending value */
   ...
   *  org.trypticon.luceneupgrader.lucene5.internal.lucene.index.LeafReader#getNumericDocValues(String)} and sorts by ascending value */
   ...
   *  org.trypticon.luceneupgrader.lucene5.internal.lucene.search.FieldComparator.TermValComparator}, but it first resolves the string
   *  to their relative ordinal positions (using the index
   *  returned by {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.index.LeafReader#getSortedDocValues(String)}), and
   *  does most comparisons using the ordinals.  For medium
   *  to large results, this comparator will be much faster
   *  than {@link org.trypticon.luceneupgrader.lucene5.internal.lucene.search.FieldComparator.TermValComparator}.  For very small
