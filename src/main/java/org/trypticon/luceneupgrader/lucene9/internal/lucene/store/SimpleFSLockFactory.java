 ...
 *
 * <p>The main downside with using this API for locking is that the Lucene write lock may not be
 * released when the JVM exits abnormally.
 *
 * <p>When this happens, an {@link LockObtainFailedException} is hit when trying to create a writer,
...
public final class SimpleFSLockFactory extends FSLockFactory {
  ...
  protected Lock obtainFSLock(FSDirectory dir, String lockName) throws IOException {
    ...
    final FileTime creationTime =
        Files.readAttributes(lockFile, BasicFileAttributes.class).creationTime();
