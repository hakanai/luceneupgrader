 ...
 * href="http://dl.acm.org/citation.cfm?id=1835490">information-based models</a> (see {@link
 * IBSimilarity}) introduced a multiplying factor. The default value for the {@code c} parameter is
 * {@code 1}.
 *
 * @lucene.experimental
 */
public class NormalizationH1 extends Normalization {
  ...
  public Explanation explain(BasicStats stats, double tf, double len) {
    return Explanation.match(
        ...
        getClass().getSimpleName() + ", computed as tf * c * (avgfl / fl) from:",
