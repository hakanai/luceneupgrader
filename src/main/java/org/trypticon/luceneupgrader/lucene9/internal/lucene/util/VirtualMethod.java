...
public final class VirtualMethod<C> {
   ...
   * @return
   *     <ul>
   *       <li>&gt; 1, iff {@code m1} is overridden/implemented in a subclass of the class
   ...
   *     </ul>
   */
  public static <C> int compareImplementationDistance(
      final Class<? extends C> clazz, final VirtualMethod<C> m1, final VirtualMethod<C> m2) {
