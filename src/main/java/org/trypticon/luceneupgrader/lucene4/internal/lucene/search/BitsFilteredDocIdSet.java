 ...
 * {@link org.trypticon.luceneupgrader.lucene4.internal.lucene.search.Filter} to apply the {@code acceptDocs}
 * passed to {@code getDocIdSet()} before returning the final DocIdSet.
 *
 * @see DocIdSet
 * @see org.trypticon.luceneupgrader.lucene4.internal.lucene.search.Filter
 */
