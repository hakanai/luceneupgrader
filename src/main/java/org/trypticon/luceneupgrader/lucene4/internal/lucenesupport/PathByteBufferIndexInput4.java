...
public class PathByteBufferIndexInput4 extends IndexInput implements RandomAccessInput {
    ...
    protected final WeakIdentityMap<PathByteBufferIndexInput4,Boolean> clones;

    public static PathByteBufferIndexInput4 newInstance(String resourceDescription, ByteBuffer[] buffers, long length, int chunkSizePower, BufferCleaner cleaner, boolean trackClones) {
        final WeakIdentityMap<PathByteBufferIndexInput4,Boolean> clones = trackClones ? WeakIdentityMap.<PathByteBufferIndexInput4,Boolean>newConcurrentHashMap() : null;
        if (buffers.length == 1) {
    ...
    PathByteBufferIndexInput4(String resourceDescription, ByteBuffer[] buffers, long length, int chunkSizePower, BufferCleaner cleaner, WeakIdentityMap<PathByteBufferIndexInput4,Boolean> clones) {
    ...
    @Override
    public final PathByteBufferIndexInput4 clone() {
        final PathByteBufferIndexInput4 clone = buildSlice((String) null, 0L, this.length);
        try {
    ...
    protected PathByteBufferIndexInput4 buildSlice(String sliceDescription, long offset, long length) {
        ...
        final PathByteBufferIndexInput4 clone = newCloneInstance(newResourceDescription, newBuffers, ofs, length);
        clone.isClone = true;
    ...
    public final void close() throws IOException {
        try {
            ...
            if (clones != null) {
                for (Iterator<PathByteBufferIndexInput4> it = this.clones.keyIterator(); it.hasNext();) {
                    final PathByteBufferIndexInput4 clone = it.next();
    ...
    static final class DefaultImpl extends PathByteBufferIndexInput4 {
        ...
        DefaultImpl(String resourceDescription, ByteBuffer[] buffers, long length, int chunkSizePower,
                    PathByteBufferIndexInput4.BufferCleaner cleaner, WeakIdentityMap<PathByteBufferIndexInput4,Boolean> clones) {
    ...
    static final class WithOffsetImpl extends PathByteBufferIndexInput4 {
        ...
        @Override
        protected PathByteBufferIndexInput4 buildSlice(String sliceDescription, long ofs, long length) {
