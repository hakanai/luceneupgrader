...
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.ByteParser;
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.DoubleParser;
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.FloatParser;
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.IntParser;
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.LongParser;
import org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldCache.ShortParser;
...
public abstract class FieldComparator<T> {
   ...
   *  org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldComparator.TermValComparator}, but it first resolves the string
   *  to their relative ordinal positions (using the index
   *  returned by {@link FieldCache#getTermsIndex}), and
   *  does most comparisons using the ordinals.  For medium
   *  to large results, this comparator will be much faster
   *  than {@link org.trypticon.luceneupgrader.lucene4.internal.lucene.search.FieldComparator.TermValComparator}.  For very small
