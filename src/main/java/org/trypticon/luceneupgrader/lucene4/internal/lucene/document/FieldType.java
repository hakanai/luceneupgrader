...
public class FieldType implements IndexableFieldType {
   ...
   * @see #setIndexOptions(org.trypticon.luceneupgrader.lucene4.internal.lucene.index.FieldInfo.IndexOptions)
   */
  @Override
   ...
   * @see #setDocValueType(org.trypticon.luceneupgrader.lucene4.internal.lucene.index.FieldInfo.DocValuesType)
   */
  @Override
