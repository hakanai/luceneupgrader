...
def main():
  ...
  w('package org.trypticon.luceneupgrader.lucene4.internal.lucene.util.automaton;')
  w('')
  w('/*')
  ...
  w('// for more details.')
  w('')
  w('import org.trypticon.luceneupgrader.lucene4.internal.lucene.util.automaton.LevenshteinAutomata.ParametricDescription;')
  w('')
  if transpose:
