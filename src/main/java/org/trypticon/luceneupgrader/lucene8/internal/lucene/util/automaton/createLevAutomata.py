...
def main():
  ...
  w(' */')
  w('package org.trypticon.luceneupgrader.lucene8.internal.lucene.util.automaton;')
  w('')
  ...
  w('// for more details.')
  w('')
  w('import org.trypticon.luceneupgrader.lucene8.internal.lucene.util.automaton.LevenshteinAutomata.ParametricDescription;')
  w('')
  if transpose:
