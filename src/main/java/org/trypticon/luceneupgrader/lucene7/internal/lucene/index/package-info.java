 ...
 * <p>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexWriter} is used to create an index, and to add, update and
 ...
 * {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.store.Directory}, depending on the configuration in {@link
 * org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexWriterConfig}. A Directory is an abstraction that typically
 * represents a local file-system directory (see various implementations of {@link
 * org.trypticon.luceneupgrader.lucene7.internal.lucene.store.FSDirectory}), but it may also stand for some other storage, such as
 * RAM.</p>

 * <a name="reader"></a>
 * <h3>IndexReader</h3>

 * <p>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexReader} is used to read data from the index, and supports
 * searching. Many thread-safe readers may be {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.DirectoryReader#open}
 ...
 * org.trypticon.luceneupgrader.lucene7.internal.lucene.index.DirectoryReader#openIfChanged}) in order to incorporate writes that may
 ...
 * global docids, but internal APIs that reference a {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.LeafReader},
 ...
 * thought of as a map that provides efficient lookup given a {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Term}
 * (roughly, a word or token), to (the ordered list of) {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.document.Document}s
 ...
 * an implementation of {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.StoredFieldVisitor}.</p>

 * <a name="docvalues"></a>
 * <p>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.DocValues} fields are what are sometimes referred to as
 ...
 * <a name="points"></a>
 * <p>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.PointValues} represent numeric values using a kd-tree data
 ...
 * </h3>
 * <p>
 * {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Fields} is the initial entry point into the
 ...
 * </h3>
 * <p>
 * {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Terms} represents the collection of terms
 ...
 * }
 * </pre>
 * {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.TermsEnum} provides an iterator over the list
 ...
 * </h3>
 * <p>
 *   {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.PostingsEnum} is an extension of
 *   {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.search.DocIdSetIterator}that iterates over the list of
 ...
 * </h3>
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.TermsEnum#docFreq}: Returns the number of 
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.TermsEnum#totalTermFreq}: Returns the number 
 ...
 *            from the index 
 *            ({@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexOptions#DOCS DOCS}) 
 ...
 * </h3>
 *     <ul>
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Terms#size}: Returns the number of 
 *            unique terms in the field. This statistic may be unavailable 
 *            (returns <code>-1</code>) for some Terms implementations such as
 *            {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.MultiTerms}, where it cannot be efficiently
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Terms#getDocCount}: Returns the number of
 ...
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Terms#getSumDocFreq}: Returns the number of
 *            postings (term-document mappings in the inverted index) for the field. This
 *            can be thought of as the sum of {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.TermsEnum#docFreq}
 *            across all terms in the field, and like docFreq() it will also count postings
 *            that appear in deleted documents.
 *        <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Terms#getSumTotalTermFreq}: Returns the number
 *            of tokens for the field. This can be thought of as the sum of 
 *            {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.TermsEnum#totalTermFreq} across all terms in the
 ...
 * </h3>
 *   <ul>
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexReader#maxDoc}: Returns the number of
 *      documents (including deleted documents) in the index.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexReader#numDocs}: Returns the number
 *      of live documents (excluding deleted documents) in the index.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.IndexReader#numDeletedDocs}: Returns the
 *      number of deleted documents in the index.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.Fields#size}: Returns the number of indexed
 *      fields.
 *   </ul>
 ...
 * a {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.search.similarities.Similarity} implementation will store some
 * of these values (possibly in a lossy way), into the normalization value for the document in
 * its {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.search.similarities.Similarity#computeNorm} method.
 *   <ul>
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getLength}: Returns the number of
 *      tokens for this field in the document. Note that this is just the number
 *      of times that {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.TokenStream#incrementToken} returned
 *      true, and is unrelated to the values in
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute}.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getNumOverlap}: Returns the number
 ...
 *      such as synonyms.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getPosition}: Returns the accumulated
 *      position value for this field in the document: computed from the values of
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.tokenattributes.PositionIncrementAttribute} and including
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.Analyzer#getPositionIncrementGap}s across multivalued
 *      fields.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getOffset}: Returns the total
 *      character offset value for this field in the document: computed from the values of
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.tokenattributes.OffsetAttribute} returned by
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.TokenStream#end}, and including
 *      {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.analysis.Analyzer#getOffsetGap}s across multivalued
 *      fields.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getUniqueTermCount}: Returns the number
 *      of unique terms encountered for this field in the document.
 *    <li>{@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.FieldInvertState#getMaxTermFrequency}: Returns the maximum
 ...
 * accessed via {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.LeafReader#getNumericDocValues}.
 */
