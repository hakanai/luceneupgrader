 ...
 * be later accessible via {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.LeafReader#getNormValues(String)}.  Lucene makes no assumption
 ...
 * at query-time with {@link org.trypticon.luceneupgrader.lucene7.internal.lucene.index.LeafReader#getNumericDocValues(String)}.
 * <p>
 ...
 *   <li>For each segment in the index, the Query creates a {@link #simScorer(SimWeight, org.trypticon.luceneupgrader.lucene7.internal.lucene.index.LeafReaderContext)}
 *       The score() method is called for each matching document.
 * </ol>
 * <p>
 * <a name="explaintime">Explanations</a>
 * When {@link IndexSearcher#explain(org.trypticon.luceneupgrader.lucene7.internal.lucene.search.Query, int)} is called, queries consult the Similarity's DocScorer for an 
