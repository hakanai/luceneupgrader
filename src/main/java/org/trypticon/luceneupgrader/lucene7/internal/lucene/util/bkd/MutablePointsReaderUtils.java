...
import org.trypticon.luceneupgrader.lucene7.internal.lucene.util.IntroSelector;
import org.trypticon.luceneupgrader.lucene7.internal.lucene.util.IntroSorter;
import org.trypticon.luceneupgrader.lucene7.internal.lucene.util.MSBRadixSorter;
import org.trypticon.luceneupgrader.lucene7.internal.lucene.util.RadixSelector;
...
public final class MutablePointsReaderUtils {
  ...
  public static void sort(int maxDoc, int packedBytesLength,
    ...
    new MSBRadixSorter(packedBytesLength + (bitsPerDocId + 7) / 8) {
      ...
      @Override
      protected org.trypticon.luceneupgrader.lucene7.internal.lucene.util.Sorter getFallbackSorter(int k) {
