...
import org.trypticon.luceneupgrader.lucene7.internal.lucene.index.CheckIndex.Status.DocValuesStatus;
...
import org.trypticon.luceneupgrader.lucene7.internal.lucene.search.LeafFieldComparator;
...
import org.trypticon.luceneupgrader.lucene7.internal.lucene.util.CommandLineUtil;
...
public final class CheckIndex implements Closeable {
  ...
  /** Command-line interface to check and exorcise corrupt segments from an index.
    ...
    Run it like this:
    <pre>
    java -ea:org.trypticon.luceneupgrader.lucene7.internal.lucene... org.trypticon.luceneupgrader.lucene7.internal.lucene.index.CheckIndex pathToIndex [-exorcise] [-verbose] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  private static int doMain(String args[]) throws IOException, InterruptedException {
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:org.trypticon.luceneupgrader.lucene7.internal.lucene...', so assertions are enabled");
  ...
  public static Options parseOptions(String[] args) {
    ...
    if (opts.indexPath == null) {
      throw new IllegalArgumentException("\nERROR: index path not specified" +
                         "\nUsage: java org.trypticon.luceneupgrader.lucene7.internal.lucene.index.CheckIndex pathToIndex [-exorcise] [-crossCheckTermVectors] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
