...
public class LatLonDocValuesField extends Field {
   ...
   * @see org.trypticon.luceneupgrader.lucene7.internal.lucene.geo.GeoEncodingUtils#decodeLatitude(int)
   * @see org.trypticon.luceneupgrader.lucene7.internal.lucene.geo.GeoEncodingUtils#decodeLongitude(int)
   */
