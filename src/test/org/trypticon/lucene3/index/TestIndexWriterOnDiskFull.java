...
import static org.trypticon.lucene3.index.TestIndexWriter.assertNoUnreferencedFiles;
  ...
  private static class FailTwiceDuringMerge extends MockDirectoryWrapper.Failure {
    ...
    public void eval(MockDirectoryWrapper dir)  throws IOException {
      ...
      for (int i = 0; i < trace.length; i++) {
        if ("org.trypticon.lucene3.index.SegmentMerger".equals(trace[i].getClassName()) && "mergeTerms".equals(trace[i].getMethodName()) && !didFail1) {
          didFail1 = true;
          throw new IOException("fake disk full during mergeTerms");
        }
        if ("org.trypticon.lucene3.util.BitVector".equals(trace[i].getClassName()) && "write".equals(trace[i].getMethodName()) && !didFail2) {
          didFail2 = true;
